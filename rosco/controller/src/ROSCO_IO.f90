...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast1
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast2
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast3
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast1
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast2
        WRITE( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast3
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast1
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast2
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_OutputSignalLast3
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast1
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast2
        READ( Un, IOSTAT=ErrStat) LocalVar%pirP%pir_InputSignalLast3
